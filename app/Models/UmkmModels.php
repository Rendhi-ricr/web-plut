...
class UmkmModels extends Model
{
    protected $table = 't_umkm';
    protected $primaryKey = 'kode_umkm';
    protected $allowedFields = ['id_user', 'alamat', 'desa', 'kecamatan', 'kode_pos', 'telp', 'email', 'nik_pemilik', 'nama_pemilik', 'alamat_pemilik', 'pendidikan_terakhir', 'tahun_beroperasi', 'jenis_usaha', 'wilayah_pemasaran', 'media_pemasaran', 'jumlah_modal_sendiri', 'jumlah_modal_pinjaman'];
    ...
    public function data_umkm($kode_umkm)
    {
        return $this->find($kode_umkm);
    }
