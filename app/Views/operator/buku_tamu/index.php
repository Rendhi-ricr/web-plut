...
<div class="container-fluid p-0">
    ...
    <div class="mb-3">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="text-end">
                    <a href="<?= base_url('operator/buku-tamu/tambah') ?>" class="btn btn-primary"><i
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="" class="btn btn-sm btn-primary my-2" id="btnSelesai"
                                            data-id="<?= $item->id_buku_tamu ?>"><i class="fa fa-check me-2"></i>Selesai
                                            Bertamu</a>
                                        <?php endif; ?>
                                        <?php if ($item->foto != null): ?>
